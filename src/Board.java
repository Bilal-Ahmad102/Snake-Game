...
public class Board extends JPanel implements ActionListener {
    ...
    private class TAdapter extends KeyAdapter {
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if((key == KeyEvent.VK_PAGE_UP) && (!leftDirection && !downDirection) ){
              rightDirection = true;
              upDirection = true;

            }
            
            if((key == KeyEvent.VK_INSERT) && (!rightDirection && !downDirection) ){
              leftDirection = true;
              upDirection = true;

            }

            if((key == KeyEvent.VK_SUBTRACT) && (!rightDirection && !upDirection) ){
              leftDirection = true;
              downDirection = true;

            }

            if((key == KeyEvent.VK_PAGE_DOWN) && (!leftDirection && !upDirection) ){
              rightDirection = true;
              downDirection = true;
